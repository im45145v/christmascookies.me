...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('money', 'https://i.ibb.co/hLy2Kx2/UIHere-1.png');
    this.load.image('paper', 'https://codecademy-content.s3.amazonaws.com/courses/learn-phaser/BOB/Bob+front.png');
  }
